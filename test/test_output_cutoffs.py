...
class TestOutputCutoffs(unittest.TestCase):
    def test_output_cutoffs_verybesthits(self):
        ...
        hmms = {
            'COG0012': pathlib.Path('../fetchmgs/data/COG0012.hmm'),
            'COG0016': pathlib.Path('../fetchmgs/data/COG0016.hmm'),
            'COG0018': pathlib.Path('../fetchmgs/data/COG0018.hmm'),
            'COG0048': pathlib.Path('../fetchmgs/data/COG0048.hmm'),
            'COG0049': pathlib.Path('../fetchmgs/data/COG0049.hmm'),
            'COG0052': pathlib.Path('../fetchmgs/data/COG0052.hmm'),
            'COG0080': pathlib.Path('../fetchmgs/data/COG0080.hmm'),
            'COG0081': pathlib.Path('../fetchmgs/data/COG0081.hmm'),
            'COG0085': pathlib.Path('../fetchmgs/data/COG0085.hmm'),
            'COG0086': pathlib.Path('../fetchmgs/data/COG0086.hmm'),
            'COG0087': pathlib.Path('../fetchmgs/data/COG0087.hmm'),
            'COG0088': pathlib.Path('../fetchmgs/data/COG0088.hmm'),
            'COG0090': pathlib.Path('../fetchmgs/data/COG0090.hmm'),
            'COG0091': pathlib.Path('../fetchmgs/data/COG0091.hmm'),
            'COG0092': pathlib.Path('../fetchmgs/data/COG0092.hmm'),
            'COG0093': pathlib.Path('../fetchmgs/data/COG0093.hmm'),
            'COG0094': pathlib.Path('../fetchmgs/data/COG0094.hmm'),
            'COG0096': pathlib.Path('../fetchmgs/data/COG0096.hmm'),
            'COG0097': pathlib.Path('../fetchmgs/data/COG0097.hmm'),
            'COG0098': pathlib.Path('../fetchmgs/data/COG0098.hmm'),
            'COG0099': pathlib.Path('../fetchmgs/data/COG0099.hmm'),
            'COG0100': pathlib.Path('../fetchmgs/data/COG0100.hmm'),
            'COG0102': pathlib.Path('../fetchmgs/data/COG0102.hmm'),
            'COG0103': pathlib.Path('../fetchmgs/data/COG0103.hmm'),
            'COG0124': pathlib.Path('../fetchmgs/data/COG0124.hmm'),
            'COG0172': pathlib.Path('../fetchmgs/data/COG0172.hmm'),
            'COG0184': pathlib.Path('../fetchmgs/data/COG0184.hmm'),
            'COG0185': pathlib.Path('../fetchmgs/data/COG0185.hmm'),
            'COG0186': pathlib.Path('../fetchmgs/data/COG0186.hmm'),
            'COG0197': pathlib.Path('../fetchmgs/data/COG0197.hmm'),
            'COG0200': pathlib.Path('../fetchmgs/data/COG0200.hmm'),
            'COG0201': pathlib.Path('../fetchmgs/data/COG0201.hmm'),
            'COG0202': pathlib.Path('../fetchmgs/data/COG0202.hmm'),
            'COG0215': pathlib.Path('../fetchmgs/data/COG0215.hmm'),
            'COG0256': pathlib.Path('../fetchmgs/data/COG0256.hmm'),
            'COG0495': pathlib.Path('../fetchmgs/data/COG0495.hmm'),
            'COG0522': pathlib.Path('../fetchmgs/data/COG0522.hmm'),
            'COG0525': pathlib.Path('../fetchmgs/data/COG0525.hmm'),
            'COG0533': pathlib.Path('../fetchmgs/data/COG0533.hmm'),
            'COG0541': pathlib.Path('../fetchmgs/data/COG0541.hmm'),
            'COG0552': pathlib.Path('../fetchmgs/data/COG0552.hmm')}
